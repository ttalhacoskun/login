  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: const LeafboardLoginScreen(),
      ),
    );
  }
}

class LeafboardLoginScreen extends StatefulWidget {
  const LeafboardLoginScreen({Key? key}) : super(key: key);

  @override
  _LeafboardLoginScreenState createState() => _LeafboardLoginScreenState();
}

class _LeafboardLoginScreenState extends State<LeafboardLoginScreen> {
